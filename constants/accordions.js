export const accrodiansData = [
    ...
    {
        header: 'Are the signing formalities physical or digital?',
        paragraph: `No, there is no need to visit the property in person. All required documentation
        will be signed digitally through a reputed digital signature provider.`
    },
    {
        header: 'Do I need to be present for property registration?',
        paragraph: `No, the assets are usually housed in a special purpose vehicle (“SPV”) which can authorise a
        person to complete the registration on behalf of the SPV.`
    },
    {
    ...
    },
    {
        ...
        paragraph: `Once an initial investment or token advance is paid, a termination fee shall apply
        for any withdrawals. The fee will be as per the terms mentioned in the Expression
        of Interest.`
    },
    {
        header: 'Is investing in properties listed on the platform risky?',
        paragraph: `Yes, as with any real estate investment, a listing on the platform carries inherent risks of loss of
        capital. Please consult your financial advisor before making any decision.`
    },
    {
        header: 'Does my investment have any lock-in period?',
        paragraph: `Yes, there is a 1-year lock-in from the time the property is registered. You are free
        to sell your stake in the SPV thereafter.`
    },
    {
    ...
    },
    {
        ...
        paragraph: `You can view the performance of your investment through our online dashboard.
        We will conduct an asset valuation on the property annually and the Net Asset Value (NAV) of the
    ...
    },
    {
        ...
        paragraph: `There is a separate Property Management team that takes care of all property management
        functions.`
    },
    {
        header: 'What are the outgoings in relation to the Property which affect distributions?',
        paragraph: `The typical deductions are tax deduction at source, property management fee and property tax.`
    },
    {
    ...
    {
        header: 'Can I transfer the transaction amount from an NRE account?',
        paragraph: `No. As per the current statutory framework, NRI investors can only
        transfer the transaction amount from a NRO account.`
    },
    {
        header: 'Can I transfer my transaction amount in foreign currency?',
        paragraph: `Transfer of foreign currency by NRIs is regulated by RBI and FEMA
        guidelines. Please reach out to us for more information on the same.`
    },
    {
        header: 'Can I get distributions and sale proceeds credited to my NRE account?',
        paragraph: `No. For a NRI investor, at present, our investment structure can only
        facilitate investments and disbursements to your NRO account. Please
        speak to your banker for a more detailed understanding of your specific
        requirements.`
    },
