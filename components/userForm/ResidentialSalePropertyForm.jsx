...
const ResidentialSalePropertyForm = ({ data, click }) => {
            ...
            <Toaster />
            {
                ...
                <section className='w-full flex justify-center py-10 absolute top-20 bottom-0 z-20 bg-white'>
                    <div className='lg:shadow-2xl md:w-[800px] lg:p-20 lg:rounded-xl p-10 absolute'>
                        ...
                        <h3 className='text-center pb-5 text-2xl uppercase font-semibold'>Add Residential Sale Property</h3>
                            ...
                            {({ values, setFieldValue }) => (
                                <Form encType="multipart/form-data">
                                    ...
                                    <div className='grid gap-6 gap-y-2 md:grid-cols-2 mt-2'>
                                        ...
                                        <Selects options={options.Bedroom} defaults={data.Bedroom}  name='Bedroom' label='Bedroom' />
...
export default ResidentialSalePropertyForm