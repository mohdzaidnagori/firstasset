...
const ResidentialRentPropertyForm = ({ data, click }) => {
    const token = getToken('token')
    const router = useRouter()
    const getLoggedUserQuery = useGetLoggedUserQuery(token);
    const [isSuccess, setIsSuccess] = useState(false)
    console.log(data.maintenance_charge)
                            ...
                            {({ values, setFieldValue }) => (
                                <Form encType="multipart/form-data">
                                    ...
                                    <div className='grid gap-6 gap-y-2 md:grid-cols-2 mt-2'>
                                        ...
                                        <Selects options={options.who_eat_non_veg} defaults={data.who_eat_non_veg} name='who_eat_non_veg' label='Who eat non veg' />
                                        <Selects options={options.who_are_bachlelor} defaults={data.who_are_bachlelor} name='who_are_bachlelor' label='Who are bachlelor' />
...
export default ResidentialRentPropertyForm