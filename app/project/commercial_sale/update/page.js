...
const CommercialsalePropertyUpdate = () => {
    ...
    const data = JSON.parse(getToken('c_sales'));
            ...
            <Toaster />
            {
                ...
                <section className='w-full flex justify-center py-10 absolute top-20 bottom-0 z-20 bg-white'>
                    <div className='lg:shadow-2xl md:w-[800px] lg:p-20 lg:rounded-xl p-10 absolute'>
                        <h3 className='text-center pb-5 text-2xl uppercase font-semibold'>Update Commercial Sell Property</h3>
...
export default CommercialsalePropertyUpdate