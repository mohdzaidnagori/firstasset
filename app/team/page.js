        ...
        <section className=''>
            <div className="flex justify-center items-center">
                <div className='lg:w-[70%] md:py-28 sm:p-8 p-5 text-center'>
                    ...
                    <p className='text-xl py-3'>We are a Team of seasoned professionals, across Capital Markets, Wealth
                        Management, Asset Management, Investment Banking & Real Estate and are
            ...
            <div className='lg:grid grid-cols-2 gap-20 lg:px-44 items-center w-full lg:py-20  text-white bg-neutral-800'>
                ...
                <div className="flex justify-center flex-col items-center border-teal-200 lg:border-2  p-10 rounded-tr-[60px] rounded-bl-[60px]">
                    ...
                    <h5 className='text-xl font-semibold'>MD & Co-Founder</h5>
                    <p className='lg:px-5 text-lg italic text-center'>Akhilesh has rich and varied experience of over 25 Years
                        in all aspects of the Capital Markets and Real Estate. <br />
                        He has lead many companies, Future Capital-Centrum,
                        Birla Capital, Emkay Global, etc, as CEO/CXO across
                        Asset / Investment Management, NBFCs and Investment
                        Banking.</p>
                </div>
