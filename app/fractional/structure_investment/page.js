...
import { GrDomain, GrHomeRounded, GrHost, GrStatusUnknown } from 'react-icons/gr';
  ...
  return (
    <div>
      <div className='flex justify-center items-center my-5 md:my-10'>
        <h2 className='text-2xl md:text-5xl font-semibold capitalize'>Investment Structure</h2>
      </div>
